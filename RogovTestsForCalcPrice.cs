...
namespace Rogov_pr31_3prakt_okFks
{
    public class RogovTestsForCalcPrice
    {
        ...
        [Fact]
        public void CalculatePrice_Return240_StudentAge18() //ГраницаСтудент
        {
            var r = new TicketRequest { Age = 18, IsStudent = true, IsVip = false, Day = DayOfWeek.Monday, SessionTime = TimeSpan.FromHours(14.41) };
            var calc = new TicketPriceCalculator();
